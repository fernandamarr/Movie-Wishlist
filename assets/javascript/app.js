$(document).ready(function () {
    ...
    $("#trending-movies").on("click", function (e) {
        ...
        $.ajax({
            ...
            for (var i = 0; i < res.length; i++) {
                ...
                // Movie poster
                var trendingMoviesImg = "<img class='results-img' src='https://image.tmdb.org/t/p/w300/" + res[i].poster_path + "'>";

                // Movie title
                var trendingMovies = $("<div>");
                trendingMovies.addClass("trend-results");
                trendingMovies.append("<div class='trend-info'><h2>" + res[i].title + "</h2><h3>Release Date: " + res[i].release_date + "</h3><button type='button' class='add-button' data-title='" + res[i].title + "'data-year='" + res[i].release_date + "'data-poster='https://image.tmdb.org/t/p/w300" + res[i].poster_path + "'>Add to Wish List</button>");
    ...
    $("#user-favorites").on("click", function (e) {
        ...
        database.ref().on("child_added", function (childSnapshot) {
            ...
            userMovies.prepend("<img class='results-img' src='" + moviePoster + "'>");
